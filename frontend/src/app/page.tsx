              ...
              <div className="lg:col-span-4 flex flex-col justify-end pb-2 lg:pl-12 border-l-0 lg:border-l border-primary">
                ...
                <motion.div variants={fadeUp} className="mt-16 pt-8 border-t border-primary/20 flex items-center justify-between">
                  <div className="flex -space-x-3">
                    {[
                      "https://i.postimg.cc/qMZmL9FP/1692647169542.jpg",
                      "https://i.postimg.cc/RF7S11Vj/IMG-20240119-093730.jpg",
                      "https://i.postimg.cc/65NH1r6m/nehza.jpg",
        ...
        <section className="py-32 bg-dark text-light border-b border-primary overflow-hidden">
          <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 lg:gap-24 relative">
              {[
                { name: "Emeka Emmanuel", role: "Law Student, IMSU", quote: "JurisMemo has been a lifesaver. The organized notes cut my study time in half and drastically improved my CGPA this semester." },
                { name: "Okafor Sarah", role: "Graduate, Nigerian Law School", quote: "The foundation I got from utilizing JurisMemo's materials during undergrad gave me a huge advantage at the Law School." },
                { name: "Nwachukwu David", role: "Law Student, IMSU", quote: "The ability to download notes as PDFs means I can study on the bus without worrying about data. Absolutely brilliant platform." }
              ].map((t, i) => (
                <motion.div
                  key={i}
